...
bool LTexture::loadFromFileKey(std::string path, SDL_Color keyColor)
{
	...
	else
	{
		...
		SDL_SetColorKey(
			...
			SDL_MapRGB(loadedSurface->format, keyColor.r, keyColor.g, keyColor.b));
...
bool LTexture::loadFromRenderedText(TTF_Font *font, std::string textureText,
									SDL_Color textColor)
{
	// Get rid of preexisting texture
	free();
...
SDL_Texture *LTexture::getTexture() { return mTexture; }